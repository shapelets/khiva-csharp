...
namespace Khiva
{
    ...
    public static class Clustering
    {
        ...
        /// </returns>
        public static Tuple<KhivaArray, KhivaArray> KMeans(KhivaArray arr, int k, float tolerance = 1e-10F,
            int maxIterations = 100)
        {
            var reference = arr.Reference;
            DLLClustering.k_means(ref reference, ref k, out var centroids, out var labels, ref tolerance,
                ref maxIterations);
