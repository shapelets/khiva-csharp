...
namespace Khiva.Interop
{
    ...
    public static class DLLDimensionality
    {
        ...
        public static extern void paa([In] ref IntPtr a, [In] ref int bins, [Out] out IntPtr result);
        ...
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void pip([In] ref IntPtr a, [In] ref int numberIps, [Out] out IntPtr result);
        ...
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void pla_bottom_up([In] ref IntPtr ts, [In] ref float maxError, [Out] out IntPtr result);
        ...
        /// <param name="result">The reduced number of points.</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void pla_sliding_window([In] ref IntPtr ts, [In] ref float maxError,
        ...
        /// <param name="resPoints">KhivaArray with the x-coordinates and y-coordinates of the selected points (x in column 0 and y in column 1).</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void ramer_douglas_peucker([In] ref IntPtr points, [In] ref double epsilon,
            [Out] out IntPtr resPoints);
        ...
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void sax([In] ref IntPtr a, [In] ref int alphabetSize, [Out] out IntPtr result);
        ...
        /// <param name="resPoints">KhivaArray with the x-coordinates and y-coordinates of the selected points (x in column 0 and y in column 1).</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void visvalingam([In] ref IntPtr points, [In] ref int numPoints,
            [Out] out IntPtr resPoints);
    }
}