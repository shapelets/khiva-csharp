...
namespace Khiva.Interop
{
    ...
    public static class DLLDistances
    {
        ...
        public static extern void dtw([In] ref IntPtr tss, [Out] out IntPtr result);
        ...
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void euclidean([In] ref IntPtr tss, [Out] out IntPtr result);
        ...
        /// between time series 0 and time series 1.</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void hamming([In] ref IntPtr tss, [Out] out IntPtr result);
        ...
        /// between time series 0 and time series 1.</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void manhattan([In] ref IntPtr tss, [Out] out IntPtr result);
        ...
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void sbd([In] ref IntPtr tss, [Out] out IntPtr result);
        ...
        /// and time series 1.</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void squared_euclidean([In] ref IntPtr tss, [Out] out IntPtr result);
    }
}