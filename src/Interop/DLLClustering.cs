...
namespace Khiva.Interop
{
    ...
    /// </summary>
    public static class DLLClustering
    {
        ...
        public static extern void k_means([In] ref IntPtr tss, [In] ref int k, [Out] out IntPtr centroids,
            [Out] out IntPtr labels, [In] ref float tolerance, [In] ref int maxIterations);
        ...
        /// <param name="maxIterations">The maximum number of iterations allowed.</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void k_shape([In] ref IntPtr tss, [In] ref int k, [Out] out IntPtr centroids,
            [Out] out IntPtr labels, [In] ref float tolerance, [In] ref int maxIterations);
    }
}