...
namespace Khiva.Interop
{
    ...
    public static class DLLNormalization
    {
        ...
        public static extern void decimal_scaling_norm([In] ref IntPtr tss, [Out] out IntPtr result);

        /// <summary> Same as decimal_scaling_norm, but it performs the operation inplace, without allocating further memory.
        ///</summary>
        /// <param name="tss">Expects an input array whose dimension zero is the length of the time series (all the same) and dimension
        /// one indicates the number of time series.</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void decimal_scaling_norm_in_place([In, Out] ref IntPtr tss);
        ...
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void max_min_norm([In] ref IntPtr tss, [In] ref double high, [In] ref double low,
            [In] ref double epsilon, [Out] out IntPtr result);

        /// <summary> Same as max_min_norm, but it performs the operation inplace, without allocating further memory.
        ///</summary>
        /// <param name="tss">Expects an input array whose dimension zero is the length of the time series (all the same) and dimension
        /// one indicates the number of time series.</param>
        /// <param name="high">Maximum final value (Defaults to 1.0).</param>
        ...
        /// between min and max values in the tss.</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void max_min_norm_in_place([In, Out] ref IntPtr tss, [In] ref double high,
            [In] ref double low, [In] ref double epsilon);
        ...
        /// time series.</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void mean_norm([In] ref IntPtr tss, [Out] out IntPtr result);
        ...
        /// one indicates the number of time series.</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void mean_norm_in_place([In, Out] ref IntPtr tss);
        ...
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void znorm([In] ref IntPtr tss, [In] ref double epsilon, [Out] out IntPtr result);
        ...
        /// those time series that may be constant or near constant.</param>
        [DllImport(DLLLibrary.KhivaPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void znorm_in_place([In, Out] ref IntPtr tss, [In] ref double epsilon);
    }
}