...
namespace khiva.interop
{
    public static class DLLDistances
    {
        ...
        public extern static void dtw(ref IntPtr tss, ref IntPtr result);
         ...
         */
        [DllImport(DLLLibrary.khivaPath, CallingConvention = CallingConvention.Cdecl)]
        public extern static void euclidean(ref IntPtr tss, ref IntPtr result);
         ...
         */
        [DllImport(DLLLibrary.khivaPath, CallingConvention = CallingConvention.Cdecl)]
        public extern static void hamming(ref IntPtr tss, ref IntPtr result);
         ...
         */
        [DllImport(DLLLibrary.khivaPath, CallingConvention = CallingConvention.Cdecl)]
        public extern static void manhattan(ref IntPtr tss, ref IntPtr result);
         ...
         */
        [DllImport(DLLLibrary.khivaPath, CallingConvention = CallingConvention.Cdecl)]
        public extern static void sbd(ref IntPtr tss, ref IntPtr result);
         ...
         */
        [DllImport(DLLLibrary.khivaPath, CallingConvention = CallingConvention.Cdecl)]
        public extern static void squared_euclidean(ref IntPtr tss, ref IntPtr result);
    }
}
